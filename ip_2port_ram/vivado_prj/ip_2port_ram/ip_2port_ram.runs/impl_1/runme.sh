...
HD_PWD='G:/FPGA/ip_2port_ram/vivado_prj/ip_2port_ram/ip_2port_ram.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ip_2port_ram.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ip_2port_ram.tcl -notrace
