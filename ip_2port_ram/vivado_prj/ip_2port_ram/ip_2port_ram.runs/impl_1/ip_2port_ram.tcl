...
namespace eval ::optrace {
  variable script "G:/FPGA/ip_2port_ram/vivado_prj/ip_2port_ram/ip_2port_ram.runs/impl_1/ip_2port_ram.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet G:/FPGA/ip_2port_ram/vivado_prj/ip_2port_ram/ip_2port_ram.runs/synth_1/ip_2port_ram.dcp
...
OPTRACE "Post-Place Phys Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force ip_2port_ram_physopt.dcp
...
OPTRACE "route_design reports" START { REPORT }
  ...
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file ip_2port_ram_timing_summary_routed.rpt -pb ip_2port_ram_timing_summary_routed.pb -rpx ip_2port_ram_timing_summary_routed.rpx -warn_on_violation "
  ...
  create_report "impl_1_route_report_bus_skew_0" "report_bus_skew -warn_on_violation -file ip_2port_ram_bus_skew_routed.rpt -pb ip_2port_ram_bus_skew_routed.pb -rpx ip_2port_ram_bus_skew_routed.rpx"
...
OPTRACE "read constraints: write_bitstream" END { }
  set_property XPM_LIBRARIES XPM_MEMORY [current_project]
  catch { write_mem_info -force -no_partial_mmi ip_2port_ram.mmi }
