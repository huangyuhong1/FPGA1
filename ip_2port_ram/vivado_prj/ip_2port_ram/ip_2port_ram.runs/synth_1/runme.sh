...
HD_PWD='G:/FPGA/ip_2port_ram/vivado_prj/ip_2port_ram/ip_2port_ram.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ip_2port_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ip_2port_ram.tcl
