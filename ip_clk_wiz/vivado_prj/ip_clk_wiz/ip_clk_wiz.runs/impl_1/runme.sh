...
HD_PWD='G:/FPGA/ip_clk_wiz/vivado_prj/ip_clk_wiz/ip_clk_wiz.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ip_clk_wiz.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ip_clk_wiz.tcl -notrace
