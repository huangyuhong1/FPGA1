...
HD_PWD='G:/FPGA/ip_clk_wiz/vivado_prj/ip_clk_wiz/ip_clk_wiz.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ip_clk_wiz.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ip_clk_wiz.tcl
