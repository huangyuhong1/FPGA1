...
HD_PWD='F:/FPGA/key_control_led/vivado_prj/key_control_led/key_control_led.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log key_control_led.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source key_control_led.tcl -notrace
