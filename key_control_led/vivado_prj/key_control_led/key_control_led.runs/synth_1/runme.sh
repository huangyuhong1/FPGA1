...
HD_PWD='F:/FPGA/key_control_led/vivado_prj/key_control_led/key_control_led.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log key_control_led.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source key_control_led.tcl
