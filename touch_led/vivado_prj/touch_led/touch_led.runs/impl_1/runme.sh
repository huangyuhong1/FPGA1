...
HD_PWD='F:/FPGA/touch_led/vivado_prj/touch_led/touch_led.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log touch_led.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source touch_led.tcl -notrace
