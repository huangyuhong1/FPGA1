...
HD_PWD='F:/FPGA/touch_led/vivado_prj/touch_led/touch_led.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log touch_led.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source touch_led.tcl
