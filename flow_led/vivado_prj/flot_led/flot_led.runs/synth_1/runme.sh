...
HD_PWD='F:/FPGA/flow_led/vivado_prj/flot_led/flot_led.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flow_led.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source flow_led.tcl
