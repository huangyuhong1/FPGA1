...
HD_PWD='G:/FPGA/key_beep/vivado_prj/key_beep/key_beep.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_key_beep.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_key_beep.tcl -notrace
