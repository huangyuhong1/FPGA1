...
HD_PWD='G:/FPGA/key_beep/vivado_prj/key_beep/key_beep.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_key_beep.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_key_beep.tcl
